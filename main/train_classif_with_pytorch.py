...
IMAGE_PATH = "/home/ubuntu/folcon/02_model_input_classif/yolo/images2/"
LABELS_PATH_JSON = "/home/ubuntu/folcon/02_model_input_classif/yolo/labels.json"
...
for lr in [1e-7, 1e-6, 1e-5, 1e-4]:
    for wd in [0, 1e-4, 1e-3, 1e-2, 1e-1]:
        ...
        # Save the model
        torch.save(model.state_dict(), f'runs/{model_name}/{model_name}.pth')